...
# return the time it takes for a certain amount of people to paint a certain amount of walls.
# The "rate" dictionary shows how many minutes it takes "people"
# people to paint "walls" walls. At that same rate, how long should it take based on the new variables.
...
def time(rate, people, walls):
    min_per_wl = rate["minutes"] / rate["walls"]
    minutes = min_per_wl * walls * (people / rate["people"])
    return int(minutes)
